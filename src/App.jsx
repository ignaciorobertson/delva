...
const TESTIMONIALS = [
  {
    ...
    name: "Martina G.",
    role: "Propietaria de comercio de alimentos",
    initial: "M",
  },
  {
    text: "Mejoró las ventas y las métricas mensuales me ayudaron a elegir mejor mis productos para vender, tenemos datos actualizados en tiempo real, es genial",
    name: "Alejandro P.",
    role: "Propietario de comercio de bebidas",
    initial: "A",
  },
];
        ...
        <div className="container" style={{ display:"flex", alignItems:"center", gap:"3rem", position:"relative", zIndex:10 }}>
          ...
          <div style={{ flex:1, minWidth:0 }}>
            ...
            <div className="fade-up-4" style={{ display:"flex", gap:"3rem", flexWrap:"wrap" }}>
              {[["20+","Flujos creados"], ["10+","Clientes"], ["100%","Proyectos entregados"]].map(([n,l]) => (
                <div key={l}>
